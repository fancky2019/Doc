...
USE NewClassesAdmin
GO
if exists (select * from dbo.sysobjects where id = object_id(N'DropBackUpOrderTablesByDayProc') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure DropBackUpOrderTablesByDayProc
GO
create proc DropBackUpOrderTablesByDayProc  
(
 @dateStr nvarchar(50)    
)
as
